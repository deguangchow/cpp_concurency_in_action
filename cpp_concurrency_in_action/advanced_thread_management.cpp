...
void test_parallel_accumulate() {
    ...
    unsigned nRes = parallel_accumulate(vct.begin(), vct.end(), 0);
...
void test_parallel_quick_sort() {
    ...
    list<unsigned> lstResult = adv_thread_mg::parallel_quick_sort<unsigned>(lstInput);
